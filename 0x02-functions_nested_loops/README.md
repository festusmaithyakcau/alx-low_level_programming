...
in C while practicing declaring and defining my own functions in the project workflow.
...
* **0. _putchar**
  * [0-putchar.c](./0-putchar.c): C program that prints `School`, followed by a
  new line. Returns 0.
